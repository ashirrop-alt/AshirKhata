  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '60px 50px 40px 50px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
          ...
          <tbody>
            {transactions.map((t, index) => (
              <tr key={t.id} style={{ borderBottom: '1px solid #f1f5f9', backgroundColor: index % 2 === 0 ? 'white' : '#fcfdfe', pageBreakInside: 'avoid' }}>
        ...
        <div style={{ marginTop: '50px', display: 'flex', justifyContent: 'flex-end', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
