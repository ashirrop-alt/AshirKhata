...
const InvoiceTemplate = React.forwardRef<HTMLDivElement, InvoiceProps>(({
  ...
  const itemsPerPage = 12; // Remarks column ki wajah se space barh gayi hai
  const pages = [];
  ...
  return (
    <div ref={ref} style={{ width: '794px', margin: '0 auto', backgroundColor: '#f1f5f9' }}>
      <style>{`
        @media print {
      ...
      {pages.map((pageEntries, pageIndex) => (
        <div
          ...
          style={{
            ...
            width: '100%',
            minHeight: '296mm', // A4 height slightly less to avoid spillover
            display: 'flex',
        ...
        >
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
              <thead>
                <tr style={{ backgroundColor: '#1e293b' }}>
                  ...
                  <th style={{ width: '120px', padding: '12px 10px', fontSize: '11px', color: 'white', textAlign: 'left' }}>TYPE</th>
          ...
          {pageIndex === pages.length - 1 && (
            <div style={{ marginTop: 'auto', paddingTop: '20px' }}>
              ...
              <div style={{ textAlign: 'center', borderTop: '1px solid #f1f5f9', paddingTop: '20px', paddingBottom: '20px' }}>
