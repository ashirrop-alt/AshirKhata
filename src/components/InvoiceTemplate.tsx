            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
              <thead>
                <tr style={{ backgroundColor: '#1e293b' }}>
                  <th style={{ width: '100px', padding: '12px 10px', fontSize: '12px', color: 'white', textAlign: 'left', borderRadius: '6px 0 0 6px' }}>DATE</th>
                  <th style={{ width: '160px', padding: '12px 10px', fontSize: '12px', color: 'white', textAlign: 'left' }}>TYPE</th>
                  <th style={{ padding: '12px 10px', fontSize: '12px', color: 'white', textAlign: 'left' }}>REMARKS</th>
                  <th style={{ width: '130px', padding: '12px 10px', fontSize: '12px', color: 'white', textAlign: 'right', borderRadius: '0 6px 6px 0' }}>AMOUNT (Rs)</th>
                </tr>
              </thead>
              <tbody>
                {pageEntries.map((t) => (
                  <tr key={t.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    <td style={{ padding: '15px 10px', fontSize: '12px', color: '#475569' }}>{t.date}</td>
