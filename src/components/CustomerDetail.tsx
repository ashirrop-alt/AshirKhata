      ...
      <main className="flex-1 overflow-hidden">
        <div className="max-w-7xl mx-auto h-full flex flex-col md:flex-row gap-4 md:gap-6 p-4 md:p-6">
          ...
          <div className="flex-none w-full md:w-72 flex flex-col space-y-4 md:space-y-5">
            <div className="bg-white dark:bg-[#0f172a] rounded-3xl p-5 md:p-6 shadow-sm border border-slate-200 dark:border-white/[0.05] relative overflow-hidden min-h-[145px] flex flex-col justify-center">
