  ...
  <div className="max-w-7xl mx-auto flex items-center justify-between">
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col text-left">
        ...
        {customer.phone && (
          <span className="text-[10px] md:text-[11px] font-bold text-slate-500 tracking-tight">
            {customer.phone}
          </span>
        )}
      </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className="rounded-xl w-10 h-10 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-200/50 dark:hover:bg-white/10 text-slate-600 dark:text-slate-400 transition-all active:scale-95 border-none"
            >
          ...
          <DropdownMenuContent 
            align="end" 
            sideOffset={8}
            className="w-48 rounded-2xl p-1.5 shadow-xl border-slate-200/60 dark:border-white/10 bg-white dark:bg-[#0f172a] overflow-hidden"
          >
            <DropdownMenuItem 
              onClick={() => makeCall('phone')} 
              className="rounded-xl py-3 px-3 cursor-pointer flex items-center gap-3 font-bold text-sm text-slate-700 dark:text-slate-200 focus:bg-blue-50 dark:focus:bg-blue-500/10 transition-colors group"
            >
            ...
            <DropdownMenuItem 
              ...
              className="rounded-xl py-3 px-3 cursor-pointer flex items-center gap-3 font-bold text-sm text-slate-700 dark:text-slate-200 focus:bg-emerald-50 dark:focus:bg-emerald-500/10 transition-colors group"
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="text-emerald-500 dark:text-emerald-400">
