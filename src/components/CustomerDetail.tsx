...
function DatePickerInput({ label, value, onChange }: any) {
  return (
    <div className="flex flex-col flex-1 px-3 py-1 min-w-0">
      {/* Label - Thora zyada premium aur readable */}
      <span className="text-[8px] font-black text-indigo-500 dark:text-indigo-400 tracking-tighter leading-none mb-1 uppercase">
        {label}
      </span>
      ...
      <div className="relative flex items-center">
        <input 
          ...
          // [color-scheme:dark] hi wo asli cheez hai jo mobile par "dd/mm/yyyy" ko white dikhayegi
          className="bg-transparent text-[11px] md:text-[12px] font-bold text-slate-700 dark:text-white outline-none w-full cursor-pointer [color-scheme:light] dark:[color-scheme:dark]"
          style={{ 
            minHeight: '22px',
            border: 'none',
            padding: '0'
