...
<div className="space-y-0">
  <div className="grid grid-cols-3 gap-3 mt-4">
    ...
    <Button
      variant="outline"
      className="flex flex-col md:flex-row h-16 md:h-11 items-center justify-center text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] text-slate-600 dark:text-slate-300 gap-1 md:gap-2 rounded-xl w-full"
    ...
    <Button
      ...
      className="flex flex-col md:flex-row h-16 md:h-11 items-center justify-center text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] text-slate-600 dark:text-slate-300 rounded-xl w-full gap-1 md:gap-2"
    >
