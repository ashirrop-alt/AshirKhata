...
<div className="mt-6 w-full">
  {/* Mobile: 3 equal columns (grid-cols-3)
      Laptop: Small centered row (md:flex) 
  */}
  <div className="grid grid-cols-3 md:flex md:flex-row items-center gap-2 md:gap-3 w-full md:w-max">
    
    {/* Reminder Button */}
    <Button 
      variant="outline" 
      className="flex flex-col md:flex-row h-16 md:h-10 items-center justify-center p-1 md:px-4 text-[10px] md:text-sm font-semibold border-slate-200 dark:border-white/10 bg-white dark:bg-[#1e293b] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 gap-1 md:gap-2 rounded-xl transition-all shadow-sm" 
      onClick={sendReminder}
    >
      <div className="flex items-center justify-center w-6 h-6 md:w-5 md:h-5 bg-green-100 dark:bg-green-500/20 rounded-lg shrink-0">
    ...
    <Button 
      ...
      className="flex flex-col md:flex-row h-16 md:h-10 items-center justify-center p-1 md:px-4 text-[10px] md:text-sm font-semibold border-slate-200 dark:border-white/10 bg-white dark:bg-[#1e293b] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl gap-1 md:gap-2 transition-all shadow-sm"
    >
      <div className="flex items-center justify-center w-6 h-6 md:w-5 md:h-5 bg-blue-100 dark:bg-blue-500/20 rounded-lg shrink-0">
    ...
    <Button 
      ...
      className="flex flex-col md:flex-row h-16 md:h-10 items-center justify-center p-1 md:px-4 text-[10px] md:text-sm font-semibold border-slate-200 dark:border-white/10 bg-white dark:bg-[#1e293b] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl gap-1 md:gap-2 transition-all shadow-sm"
    >
      <div className="flex items-center justify-center w-6 h-6 md:w-5 md:h-5 bg-emerald-100 dark:bg-emerald-500/20 rounded-lg shrink-0">
