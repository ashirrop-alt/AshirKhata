                  ...
                  {customer.phone && (
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48 rounded-2xl p-2 shadow-xl border-slate-100">
                        ...
                        {/* Phone Call Option */}
                        <DropdownMenuItem onClick={() => makeCall('phone')} className="gap-2 cursor-pointer">
                          <Phone className="w-4 h-4 text-slate-500" />
                          Phone Call
                        </DropdownMenuItem>

                        {/* WhatsApp Call Option - Updated onClick */}
                        <DropdownMenuItem onClick={() => makeCall('whatsapp')} className="gap-2 cursor-pointer">
                          <svg
                            viewBox="0 0 24 24"
                            width="16"
                            height="16"
