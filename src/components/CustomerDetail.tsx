  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 dark:bg-[#020617] transition-colors duration-500 overflow-hidden">
      ...
      <main className="flex-1 overflow-hidden">
        <div className="max-w-7xl mx-auto h-full flex flex-col md:flex-row gap-4 md:gap-6 px-5 py-4 md:p-6">

          {/* LEFT SIDE */}
          <div className="flex-none w-full md:w-72 space-y-4">
            {/* EXACT height match with Home Screen to prevent list jumping */}
            <div className="relative w-full max-w-md mx-auto rounded-3xl p-5 md:p-6 shadow-sm bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/[0.05] overflow-hidden transition-all min-h-[120px] md:min-h-[145px] flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 gap-3 w-full max-w-md mx-auto">
