        ...
        <div className="max-w-7xl mx-auto h-full flex flex-col md:flex-row gap-4 md:gap-6 p-4 md:p-6">
          ...
          <div className="flex-none w-full md:w-72 space-y-4">
            ...
            <div className="space-y-0 md:space-y-2">
              ...
              {/* Grid: Mobile par 3 columns, Laptop par 1 column (Single Stack) */}
              <div className="grid grid-cols-3 md:grid-cols-1 gap-2">

                {/* WhatsApp Reminder Button */}
                <Button
                  variant="outline"
                  className="flex flex-col md:flex-row h-16 md:h-11 text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 gap-1 md:gap-2 rounded-xl w-full"
                ...
                <Button
                  ...
                  className="flex flex-col md:flex-row h-16 md:h-11 text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl gap-1 md:gap-2 transition-all w-full"
                >
