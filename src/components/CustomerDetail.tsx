...
<div className="space-y-0">
  {/* Grid layout jo laptop par bhi 3 columns hi rakhega taake buttons stretch na hon */}
  <div className="grid grid-cols-3 gap-2 md:gap-3 mt-4 max-w-fit">

    {/* Reminder Button */}
    <Button
      variant="outline"
      className="flex flex-col h-16 items-center justify-center text-[10px] md:text-xs font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] text-slate-600 dark:text-slate-300 gap-1 rounded-xl w-24 md:w-28"
