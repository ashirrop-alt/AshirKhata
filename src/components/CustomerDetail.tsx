  ...
  <DropdownMenu>
    <DropdownMenuTrigger asChild>
      <Button 
        variant="ghost" 
        size="icon" 
        className="rounded-xl w-9 h-9 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-200/50 dark:hover:bg-white/10 text-slate-600 dark:text-slate-400 transition-all active:scale-95 border-none"
      >
    ...
    <DropdownMenuContent 
      align="end" 
      sideOffset={6}
      className="w-40 rounded-xl p-1 shadow-lg border-slate-200/60 dark:border-white/10 bg-white dark:bg-[#0f172a] overflow-hidden"
    >
      <DropdownMenuItem 
        onClick={() => makeCall('phone')} 
        className="rounded-lg py-2 px-2.5 cursor-pointer flex items-center gap-2.5 font-semibold text-[13px] text-slate-700 dark:text-slate-200 focus:bg-blue-50 dark:focus:bg-blue-500/10 transition-colors group"
      >
        {/* Icon default mein hi Blue hai */}
      ...
      <DropdownMenuItem 
        ...
        className="rounded-lg py-2 px-2.5 cursor-pointer flex items-center gap-2.5 font-semibold text-[13px] text-slate-700 dark:text-slate-200 focus:bg-emerald-50 dark:focus:bg-emerald-500/10 transition-colors group"
      >
        {/* Icon default mein hi Green hai */}
        <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" className="text-emerald-500 dark:text-emerald-400">
