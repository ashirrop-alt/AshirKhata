  ...
  <DropdownMenu>
    <DropdownMenuTrigger asChild>
      <Button 
        variant="ghost" 
        size="icon" 
        className="rounded-xl w-9 h-9 md:w-10 md:h-10 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-200/50 dark:hover:bg-white/10 text-slate-600 dark:text-slate-400 transition-all border border-transparent active:scale-95"
      >
    ...
    <DropdownMenuContent 
      align="end" 
      sideOffset={10}
      className="w-44 rounded-2xl p-1.5 shadow-xl border-slate-200/60 dark:border-white/10 bg-white dark:bg-[#0f172a] animate-in fade-in slide-in-from-top-2 duration-200"
    >
      <DropdownMenuItem 
        onClick={() => makeCall('phone')} 
        className="rounded-xl py-2.5 px-3 cursor-pointer flex items-center gap-3 font-medium text-sm text-slate-700 dark:text-slate-200 focus:bg-slate-100 dark:focus:bg-white/5 transition-colors group"
      >
        <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-white/10 flex items-center justify-center group-hover:bg-blue-500/10 transition-colors">
          <Phone className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400 group-hover:text-blue-500" />
        </div>
        Phone Call
      </DropdownMenuItem>
      ...
      <DropdownMenuItem 
        ...
        className="rounded-xl py-2.5 px-3 cursor-pointer flex items-center gap-3 font-medium text-sm text-slate-700 dark:text-slate-200 mt-0.5 focus:bg-slate-100 dark:focus:bg-white/5 transition-colors group"
      >
        <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-white/10 flex items-center justify-center group-hover:bg-emerald-500/10 transition-colors">
          <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" className="text-slate-500 dark:text-slate-400 group-hover:text-emerald-500">
