...
export function CustomerDetail({ customer, onBack }: Props) {
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 dark:bg-[#020617] transition-colors duration-500 overflow-hidden">
      ...
      {/* --- HEADER --- */}
      <header className="flex-none h-16 md:h-18 bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-white/[0.05] px-4 md:px-6 z-40 shadow-sm transition-all">
