...
<div className="space-y-0">
  {/* Container: Mobile par grid, Laptop par flex (No Stretching) */}
  <div className="grid grid-cols-3 md:flex md:flex-row md:items-start gap-2 md:gap-4 mt-4">

    {/* WhatsApp Reminder Button */}
    <Button
      variant="outline"
      className="flex flex-col md:flex-row h-16 md:h-11 items-center justify-center text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 gap-1 md:gap-2 rounded-xl w-full md:w-fit md:min-w-[130px] md:px-4 transition-all"
    ...
    <Button
      ...
      className="flex flex-col md:flex-row h-16 md:h-11 items-center justify-center text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl w-full md:w-fit md:min-w-[100px] md:px-6 transition-all"
    >
    ...
    <Button
      ...
      className="flex flex-col md:flex-row h-16 md:h-11 items-center justify-center text-[10px] md:text-sm font-bold border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl w-full md:w-fit md:min-w-[120px] md:px-4 transition-all"
    >
