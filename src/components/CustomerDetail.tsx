  ...
  <DropdownMenu>
    ...
    >
      <DropdownMenuItem 
        ...
        className="rounded-lg py-2 px-2.5 cursor-pointer flex items-center gap-2.5 font-semibold text-[13px] text-slate-700 dark:text-slate-200 focus:bg-slate-100 dark:focus:bg-white/5 transition-colors group"
      >
        <Phone className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-500 transition-colors" />
        Phone Call
      </DropdownMenuItem>
      ...
      <DropdownMenuItem 
        ...
        className="rounded-lg py-2 px-2.5 cursor-pointer flex items-center gap-2.5 font-semibold text-[13px] text-slate-700 dark:text-slate-200 focus:bg-slate-100 dark:focus:bg-white/5 transition-colors group"
      >
        <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" className="text-slate-500 group-hover:text-emerald-500 transition-colors">
