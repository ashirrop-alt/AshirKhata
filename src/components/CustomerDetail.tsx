...
<div className="space-y-0"> 
  ...
  <div className="grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-4 mt-4">
    ...
    <Button
      ...
      w-full max-w-[160px] mx-auto transition-all"
    ...
    <Button
      ...
      hover:bg-slate-50 dark:hover:bg-slate-800 
      text-slate-600 dark:text-slate-300 
      rounded-xl w-full max-w-[140px] mx-auto transition-all"
    >
    ...
    <Button
      ...
      hover:bg-slate-50 dark:hover:bg-slate-800 
      text-slate-600 dark:text-slate-300 
      rounded-xl w-full max-w-[150px] mx-auto transition-all"
    >
