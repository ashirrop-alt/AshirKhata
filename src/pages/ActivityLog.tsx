                    ...
                    <div className="text-sm font-black tracking-tight flex items-center flex-wrap gap-y-1">
                      {log.action_type === 'DELETE' ? (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {/* Spaced Edited Label */}
                          <span className="text-[9px] bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 px-2 py-0.5 rounded-md border border-indigo-500/20 uppercase tracking-tighter ml-3 font-black">Edited</span>
                        </div>
                      )}
                    </div>
